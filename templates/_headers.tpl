...
/*
  Content-Security-Policy: default-src 'self'; script-src 'self' https://telegram.org; connect-src 'self' {{ cfg.api_base }}; img-src 'self' data: https://t.me https://yt3.googleusercontent.com https://yt3.ggpht.com; style-src 'self' 'unsafe-inline'; frame-src https://oauth.telegram.org; frame-ancestors 'self' https://web.telegram.org
