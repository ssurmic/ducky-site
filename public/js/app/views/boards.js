...
export async function mount(root, route={}) {
  ...
  card.append(header,...(currentAccess?[]:[accessNote]),...(screenEntry?[screenPanel,marketPanel]:[marketPanel,screenPanel]),el('details.radar-browse',el('summary',s('radar.browse_questions')),starters),coverage,pelosiJump,el('div.radar-layout',sidebar,main));
