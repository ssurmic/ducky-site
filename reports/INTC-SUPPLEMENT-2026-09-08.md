...
Approved scope: publish this collapsible supplement after successful CI; preserve the v9 main tour and guide. Production entry will be `https://duckybot.app/#intc-tutorial` and `https://duckybot.app/en/#intc-tutorial` after deployment and live verification.
