...
The usage-guide correction was published from `102d1babd3f0cef1be2269a9401ee5cb91e56ee5` after main CI run `34270851874` succeeded, in Pages deployment `41b4fc53`. Fresh production IAB checks confirm all seven steps and exact timestamps in each language, the original 4:09 source link, unchanged media sources and the retained main guide. This was a text-only acceptance check; it does not claim another full playback.
