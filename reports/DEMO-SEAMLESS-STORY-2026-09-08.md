...
- Independently written, native-language female narration (Xiaoxiao/Ava, native synthesis +9%). No post-generation speed changes. Provider end silence is shortened while retaining the last word and measured waveform tail. The final frame remains after speech. The closing button and X/Reddit preview are placed outside the caption area; entering stock chips no longer overlap.
