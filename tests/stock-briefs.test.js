...
test('Vibe Check uses one heading, direction first, attention in details, and never links the retired Degen route',async()=>{
 ...
 const root=document.createElement('div');const cleanup=await mountSocial(root,{view:'vibe',query:new URLSearchParams()});
